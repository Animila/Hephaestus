...
import { Auth_context, seAuth } from "@/contexts/auth_context";
...
const ConfirmPage = () => {
  ...
  return (
    <div className="flex h-screen sm:flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-white sm:bg-blue md:bg-white">
        <div
          className="sm:flex md:hidden sm:py-[30px] md:flex-1 bg-blue text-white flex-col justify-center items-center">
          <h1 className="text-3xl md:text-5xl font-bold text-center">Введите код подтверждения</h1>
        </div>
